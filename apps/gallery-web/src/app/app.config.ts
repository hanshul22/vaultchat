...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    // Bind gallery-web's concrete AuthService to the shared auth token so
    // the shared interceptors and guard can resolve it without importing
    // app-local code (same pattern as auth-web).
